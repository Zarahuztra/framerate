      ...
      <main className="flex-grow flex items-center justify-center p-2 overflow-hidden">
        <div
          className="bg-[#00d8f1] border-2 border-[#1a1a1a] text-[#1a1a1a] rounded-3xl
                       w-full max-w-screen-lg h-full px-3 py-4 md:p-8 
                       flex flex-col items-center text-center"
        >
          {/* Tekst-seksjon (øverst) */}
          <div className="flex-shrink-0 mb-4">
            <h1 className="font-display text-3xl sm:text-5xl md:text-7xl mb-2">
              Discover, learn, and play
            </h1>
            <div className="font-display text-lg sm:text-2xl md:text-4xl mt-2">
          ...
          {/* Knappe-seksjon */}
          <div className="flex space-x-4 mt-8 mb-4 sm:mt-8 sm:mb-8 flex-shrink-0">
            <button
          ...
          <div className="w-full flex-shrink-0 mb-4">
            {!activeCategory ? (
                ...
                {categories.map((cat) => {
                  ...
                  return (
                    <div
                      ...
                      className="flex flex-col items-center w-16 cursor-pointer transition-transform transform hover:scale-110"
                    >
                      {/* Shrink icon on mobile, normal on desktop */}
                      <CategoryIcon className="w-10 h-10 sm:w-16 sm:h-16" />
                      <span className="text-xs sm:text-sm mt-1 font-semibold">
                        {cat.name}
                      </span>
                    </div>
                  );
              ...
              <div>
                ...
                <div className="flex flex-wrap justify-center gap-x-3 gap-y-3 md:gap-x-6">
                  {filteredIcons.map((icon) => {
                    ...
                    return IconComponent ? (
                      <div
                        ...
                        className="group relative flex flex-col items-center w-12 md:w-14 transition-transform transform hover:-translate-y-1 cursor-pointer"
                      >
